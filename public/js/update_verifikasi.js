...
function sendVerificationRequest(id, button) {
  $.ajax({
    type: 'POST',
    url: 'https://fasilkompoint.simaport.net/public/?url=Verifikasi/updateVerification',
    data: { id: id },
...
function sendRevertedRequest(id, button) {
  $.ajax({
    type: 'POST',
    url: 'https://fasilkompoint.simaport.net/public/?url=Verifikasi/revertVerification',
